      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <p className="col-span-2">{formatDateTime(schedule.start_at)}</p>
          </div>

          <div className="grid grid-cols-3 gap-4">
            <p className="font-bold">講師名</p>
            <p className="col-span-2">{schedule.event.instructor_name}</p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <p className="col-span-2">{paymentMethod.payment_method}</p>
          </div>

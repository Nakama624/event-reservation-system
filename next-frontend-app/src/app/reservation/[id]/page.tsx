      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <p className="col-span-2">{reservation.schedule.event.title}</p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <p className="col-span-2">{reservation.participants}人</p>
          </div>

          <div className="grid grid-cols-3 gap-4">
            <p className="font-bold">支払ステータス</p>
            <p className="col-span-2">{reservation.payment_status}</p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <p className="col-span-2">¥{reservation.amount.toLocaleString()}</p>
          </div>
        </div>
      </div>

          ...
          <table className="w-full">
            <thead>
              <tr className="border border-gray-300 bg-gray-300 h-12 text-lg">
                ...
                <th className="px-4 py-3 whitespace-nowrap">講師名</th>
                <th className="px-4 py-3 whitespace-nowrap">予約人数</th>
                <th className="px-4 py-3 whitespace-nowrap">支払ステータス</th>
                <th></th>
                <th></th>
              </tr>
            </thead>
                  ...
                  >
                    ...
                    <td className="px-4">
                      {isPast ? (
                        ...
                        <span className="text-gray-400">キャンセル不可</span>
                      )}
                    </td>

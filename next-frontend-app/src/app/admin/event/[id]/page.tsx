  ...
  return (
    <div className="m-20">
            ...
            <table className="w-full text-xl">
              <tbody>
                <tr className="h-16 border-b">
                  <th className="w-40 text-left text-gray-500">日時</th>
                  <td>{formatDateTime(schedule.start_at)}</td>
                </tr>

                <tr className="h-16 border-b">
                  <th className="w-40 text-left text-gray-500">講師</th>
                  <td>{schedule.instructor_name}</td>
                </tr>

                <tr className="h-16 border-b">
                  <th className="w-40 text-left text-gray-500">定員</th>
                  <td>{schedule.capacity}人</td>
                </tr>

                <tr className="h-16 border-b">
                  <th className="w-40 text-left text-gray-500">申込済人数</th>
                  <td>{schedule.total_participants}人</td>
                </tr>

                <tr className="h-16 border-b">
                  <th className="w-40 text-left text-gray-500">残席</th>
                  <td>{schedule.remaining_capacity}席</td>
                </tr>

                <tr className="h-16">
                  <th className="w-40 text-left text-gray-500">状態</th>
                  <td>
      ...
      <section className="mt-10">
        <h2 className="text-2xl font-bold text-gray-500 mb-4">予約者一覧</h2>
